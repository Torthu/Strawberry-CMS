 ...
 */
 ...
 foreach($xhtml_tags as $i) {
   $source = preg_replace('/&lt;' .$i. '(&gt;|[[:space:]])/i','<span style="color: ' .$options['color']['tags']. ';font-weight:bold;">&lt;' .$i. '\\1</span>',$source);
 ...
 $source = preg_replace('/([[:space:]]|&quot;|\'|\?)&gt;/i','\\1<span style="color: ' .$options['color']['tags']. ';font-weight:bold;">&gt;</span>',$source);
